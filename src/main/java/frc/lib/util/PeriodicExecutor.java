...
public class PeriodicExecutor {
   ...
   *     period)
   * @param offsetSeconds the delay in seconds before the first eligible execution (will be aligned
   *     to the base period). If this is greater than {@code periodSeconds} than the offset will be
   *     {@code offsetSeconds % periodSeconds}
